...
class AboutSymbols < EdgeCase::Koan
  ...
  def test_method_names_become_symbols
    dizgi_gibi_semboller = Symbol.butun_semboller.map { |x| x.to_s }
  ...
  in_ruby_version("mri") do
    RubyConstant = "Alkışlarken çıkan ses nedir?"
    def test_constants_become_symbols
      butun_semboller = Symbol.butun_semboller
  ...
  def test_to_s_is_called_on_interpolated_symbols
    sembol = :yar
    dizgi = "ana gibi #{sembol} bağdat gibi diyar olmaz."
  ...
  # Sembollerin "sabit dizgiler" olmadıkları kavrayabilmek
