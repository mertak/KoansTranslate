...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_a_regexp_can_search_a_string_for_matching_content
    assert_equal __, "Bağdat gibi diyar"[/gibi/]
  end

  def test_a_failed_match_returns_nil
    assert_equal __, "Bağdat gibi diyar"[/olmayan/]
  end
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    assert_equal __, "aradığımız numara 42"[/[0123456789]+/]
    assert_equal __, "aradığımız numara 42"[/\d+/]
  end

  def test_character_classes_can_include_ranges
    assert_equal __, "aradığımız numara 42"[/[0-9]+/]
  end
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    # NOT:  Bir programcı kelimeyi böyle tanımlar(This is more like how a programmer might define a word).
